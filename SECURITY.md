...
## 🎀 keeping my projects safe

Security is super important to me! 💖 I want to ensure that all my projects and the people using them stay safe. If you happen to find any security vulnerabilities in my code, I would really appreciate your help in reporting them responsibly. 
...
When in doubt, updating to the newest version is always the safest bet! ✨
...
- **Details**: Any additional context or affected versions.
- **PoC (Proof of Concept)**: Step-by-step instructions to reproduce the issue.
